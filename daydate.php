...
<head>
    ...
    <link rel="stylesheet" href="daydate.css">
</head>
...
<body>
    <div class="video-container">
        <video autoplay muted loop id="myVideo">
            <source src="img/daydatereal1.webm" type="video/mp4">
    ...
    <div class="bg2">
        <div class="container-fluid">
            <div class="tc">
                <h1 style="font-size: 40px; margin-left: 28pc;">The Day-Date is the watch of a <br> global, multicultural and ever- <br>changing world. </h1>
            </div>
        </div>

        <div class="video-container2">
            <video autoplay muted loop id="myVideo2">
                <source src="img/daydatewatch.webm" type="video/mp4">
                Your browser does not support HTML5 video.
            </video>
        </div>

        <div class="con3">
            <h2 class="d1" style="font-size: 45px; margin-left:28pc;">"Dates and days are essential."</h2>
            <p class="d2" style="font-size: 18px; margin-left:28pc;">Hans Wilsdorf</p>
            <img src="img/rdaydate.jpg" alt="" style="height: 750px; width: 600px; margin-left:28pc;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 40px;">
                </div>
            </div>
            <p class="d2" style="font-size: 18px; margin-left:28pc;">The Day-Date was originally designed to be a precious instrument for <br> everyday use. Thanks to a watchmaking prowess that was <br>unprecedented at the time, it offered a solution to those requiring <br>complete mastery of their personal calendar: the Day-Date was the <br> first self-winding, waterproof chronometer wristwatch to display, in <br>addition to the date, the day of the week spelt out in full, in two <br>separate windows. Both change simultaneously at midnight. This <br>revolutionary switch continues to fascinate, nearly seven decades <br>later.</p>
        </div>

        <div class="con43">
            <h2 class="d1" style="font-size: 45px; margin-left:28pc;">The balance between elegance and technical excellence</h2>
            <p class="d2" style="font-size: 18px; margin-left:28pc;">Instantly recognizable, its unique design has forged its identity. At its launch, the Day-Date was the only watch with a semi-circular window at 12 o’clock displaying the day of the week spelt out in full. With its specially-designed President bracelet available only in precious metal – gold or platinum – it is the watch of prestige par excellence.</p>
            <div class="spacer">
        ...
        <div class="con3">
            <h2 class="d13" style="font-size: 45px; margin-left:28pc;">Unique and universal, the Day-Date speaks its wearer’s language</h2>
            <p class="d2" style="font-size: 18px; margin-left:28pc;">Although the days may be the same wherever you are in the world, <br> they are written differently depending on the language. Using most <br>writing systems – Latin, Arabic, Cyrillic, Hebrew, Japanese, Chinese <br>ideograms and even the Ge'ez alphasyllabary used in the Horn of <br>Africa – the Day-Date expresses the cultural identity of its wearer. <br> It is a truly international, universal and personal watch.</p>
            <img src="img/daydateimg.jpg" alt="" style="height: 630px; width: 600px; margin-left:28pc;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
        ...
        <div class="con2">
            <h2 class="hh">A precious ally</h2>
            <p class="pi" style="font-size: 18px;">
                Famous for being the “presidents’ watch” of the past and <br>inspiring the leaders of the future, the Day-Date graces <br>the wrists of exceptional men and women who dedicate <br> their lives to the accomplishment of their ideals. Decades <br> come and go, but the Day-Date remains where it has <br> always been – at the cutting edge of modernity.
            </p>
        </div>
        ...
        <div class="box9">
            <div class="con1">
                ...
                <div class="ml-auto">
                    <p class="pb" style="font-size: 23px; letter-spacing: 0.3px;">All the flows of traced gold that we use are <br>certified by external audits.</p>
