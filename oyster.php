...
<body>
    <div class="video-container">
        <video autoplay muted loop id="myVideo">
            <source src="img/oyster1.webm" type="video/mp4">
        ...
        <div class="new">
            <h1>Make the world your Oyster</h1>
        </div>
    </div>
    ...
    <div class="container" class="dark-theme css-s30hrt e1rkjwns2" style="opacity: 0.904255;">
        <div class="row featurette my-4">
            <div class="col-md-7">
                <h1 class="featurette-heading">Freedom of movement</h1>
            </div>
            <div class="col-md-5 order-md-1">
                <p class="lead">As the purest expression of Rolex’s manufacturing spirit, the Oyster Perpetual was designed for those who see the world as having boundless possibilities. As the quintessential wristwatch, it carries the brand’s founding legacy while following the movement of its era. Reliable on every count, the Oyster Perpetual withstands the demands of contemporary life and makes way for endless future possibilities that are ours to pursue.
                </p>
                <div class="spacer">
    ...
    <div class="bg2">
        <div class="con43">
            <h2 class="d1" style="font-size: 45px;">Universal symbols</h2>
            <p class="d2" style="font-size: 18px;">The aesthetics of the Oyster Perpetual models set them apart as symbols of universal and classic style. They embody timeless form and function, firmly rooted in the pioneering origins of Rolex.</p>
            <div class="spacer">
    ...
    <div class="video-container2">
        <video autoplay muted loop id="myVideo2">
            <source src="img/oyy.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
    </div>
    ...
    <div class="bg3">
        <div class="con3">
            <h2 class="d13" style="color: white; font-size: 45px;">Oyster Perpetual watches stand out with dials in subtle or vibrant colours, ensuring that they always sport a contemporary look.</h2>
            <img src="img/oyg.jpg" alt="" style="height: 630px; width: 600px;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 50px;">
                </div>
            </div>
            <h2 class="d1" style="font-size: 45px;">Optimal protection</h2>
            <p class="d2" style="font-size: 18px;">The Oyster case of the Oyster Perpetual models is guaranteed waterproof to a depth of 100 metres (330 feet). Its middle case is crafted exclusively from a solid block of Oystersteel, a particularly corrosion-resistant alloy. The case back, edged with fine fluting, is hermetically screwed down with a special tool exclusive to Rolex watchmakers. Another core component in the watertight structure is the Twinlock winding crown, fitted with a double waterproofness system, which screws down securely against the case. The waterproof Oyster case provides the Rolex movement with optimal protection from water and dust.</p>
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
    ...
    <div class="con2">
        <p class="pi" style="margin-left: 58pc;">
            The Oyster Perpetual is <br>the purest expression of <br> the Oyster concept.
        </p>
    </div>

    <div class="bg4">
        <div class="con3">
            <h2 class="d1">Oystersteel</h2>
            <p class="d2">Specially developed for the brand, Oystersteel belongs to the 904L steel family, alloys most commonly used in advanced-technology fields such as the aerospace and chemical industries. Oystersteel is particularly corrosion-resistant, offers an exceptional sheen and maintains its lustre even in the harshest environments.</p>
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
            <img src="img/oyhand.jpg" alt="" style="height: 630px; width: 600px;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
    ...
    <div class="video-container2">
        <video autoplay muted loop id="myVideo2">
            <source src="img/oooooy.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
    </div>
    ...
    <div class="box9">
        <div class="con1">
            <h2 class="h2">The Traceability Of <br> Our raw Materials</h2>
            <div class="ml-auto">
                <p class="pb" style="font-size: 23px; letter-spacing: 0.3px;">Oystersteel is an alloy for which our exclusive <br>Suppliers use waste from European industry in <br> their manufacturing process.</p>
    ...
    <div class="oo">
        <div class="container" style="margin-left: 6pc;">
            <img id="mg" src="img/file (1).png" alt="" />
            ...
            <div class="con">
                <div class="box" id="b1">
                    ...
                    <p style="font-size: 17px;">Oyster, 41mm, Oystersteel <br> Reference 124300</p>
                    <p style="font-size: 17px;">$6,684.094</p>
                    <p style="font-size: 17px;">₹557,400</p>
                </div>
                <div class="box" id="b2">
                    <p>Oysterprepetual</p>
                    <p style="font-size: 17px;">This Oyster has a Bright Black Features a white dial and an oyster bracelate</p>
                    <p style="font-size: 17px;">Make The world your Oyster</p>
                </div>
                <div class="box" id="b3">
                    <p style="font-size: 17px;">Light is coveted for its <br> lustre and nobility. Steel <br>reinforces strength and <br>reliability. Together, they <br>harmoniously combine the <br>best of their properties.</p>
                    <p style="font-size: 17px;">Bright Black Dial</p>
                </div>
                <div class="box" id="b4">
                    <p style="font-size: 17px;">Oysterbracelet is a<br>perfectformfunction,<br>aestheticsand technology,<br> designed to be both robust.</p>
                    <p style="font-size: 17px;">Alchemy function</p>
                </div>
            </div>
        </div>
        <div class="spacer">
