...
<body>
    <div class="video-container">
        <video autoplay muted loop id="myVideo">
            <source src="img/air.webm" type="video/mp4">
    ...
    <div class="con3">
        <h2 class="d1"  style="font-size: 45px;">"The peculiar qualities of this Rolex watch render it eminently suitable for flying purposes and I propose to use it on all my long-distance flights in the future."</h2>
        <p class="d2">English aviator Charles Douglas Barnard, 1930s</p>
        <div class="spacer">
    ...
    <div class="video-container2">
        <video autoplay muted loop id="myVideo2">
            <source src="img/air2.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
    </div>
    ...
    <div class="bg2">
        ...
        <div class="card-group">
            ...
            <div class="card">
                <img class="card-img-top" src="img/ac2.jpg" alt="Card image cap">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/ac3.jpg" alt="Card image cap">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/ac4.jpg" alt="Card image cap">
            </div>
        ...
        <div class="con30">
            <h2 class="d11" >Distinctive black dial with a combination of large 3, 6 and 9 numerals marking the hours and a prominent minutes scale for navigational time readings.</h2>
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
    ...
    <img src="img/afix.jpg" alt="" style="height: 700px; width: 100%;" class="ii1">

    <div class="oo">
        <div class="container" style="margin-left: 6pc;">
            <img id="mg" src="img/file9.png" alt="" />
            ...
            <div class="con">
                <div class="box" id="b1">
                    <p style="font-size: 20px;">Air-King</p>
                    <p style="font-size: 17px;">Oyster, 41mm, Oystersteel <br> Reference 126900</p>
                    <p style="font-size: 17px;">$7,764.534</p>
                    <p style="font-size: 17px;">₹747,500</p>
                </div>
                <div class="box" id="b2">
                    <p>Oysterprepetual</p>
                    <p style="font-size: 17px;">This Air‑King has a white Gold Features a white dial and an original Rolex oyster.</p>
                    <p style="font-size: 17px;">Take to the skies</p>
                </div>
                <div class="box" id="b3">
                    <p style="font-size: 17px;">Air features is coveted for its <br> lustre and nobility. Steel <br>reinforces strength and <br>reliability. Together, they <br>harmoniously combine the <br>best of their properties.</p>
                    <p style="font-size: 17px;">Navigational readings</p>
                </div>
                <div class="box" id="b4">
                    ...
                    <p style="font-size: 17px;">The Oyster bracelet</p>
                </div>
            </div>
        </div>
        <div class="spacer">
