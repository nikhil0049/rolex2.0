...
<body>
    <div class="video-container">
        <video autoplay muted loop id="myVideo">
            <source src="img/cosmograph.webm" type="video/mp4">
        ...
        <div class="new">
            <h1>The triumph of endurance</h1>
        </div>
    </div>
    ...
    <div class="container" class="dark-theme css-s30hrt e1rkjwns2" style="opacity: 0.904255;">
        <div class="row featurette my-4">
            <div class="col-md-7">
                <h1 class="featurette-heading">Watch or legend?</h1>
            </div>
            <div class="col-md-5 order-md-1">
                <p class="lead">Launched in 1963, the Cosmograph Daytona has long since transcended its status in the world of watchmaking to become an icon. Its name, inextricably linked to the famous racetrack, as well as its graphic face, have made it a legend. Yet it is at the heart of this exceptional chronograph that the true mechanics of the legend beat: a movement designed and produced entirely by the Rolex Manufacture that delivers superlative performance in all circumstances. Constantly improved and refined over time, the Cosmograph Daytona has proved to be as reliable as it is precise.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg2">
        <div class="con43">
            <h2 class="d1" style="font-size: 45px; margin-top:26pc;">"You must stay calm but you must also act and not be afraid; you must go forward courageously."</h2>
            <p class="d2">Hans Wilsdorf</p>
            <div class="spacer">
        ...
        <div class="bb">
            <img src="img/cos2.jpg" alt="" style="height: 750px; width: 600px;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 70px;">
                </div>
            </div>
    ...
    <div class="video-container2 image-overlay">
        <video autoplay muted loop id="myVideo2">
            <source src="img/daytona2.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
        <div class="con4">
            <div class="overlay-text">
                <h2 class="e1" style="font-size: 45px;">Movements of <br> excellence</h2>
                <p class="e2" style="font-size: 18px;">Behind the legendary design of the Cosmograph Daytona lies a modern story of Swiss watchmaking. Initially equipped with Valjoux movements, in 1988 the Cosmograph Daytona was fitted with calibre 4030, an adaptation of the Zenith El Primero calibre, the world’s first high-frequency self-winding chronograph movement. Rolex engineers worked to optimize this calibre – by reducing its frequency to 4 Hz – to guarantee its robustness and reliability over time. 
                <div class="spacer">
    ...
    <div class="bg2">
        <div class="con3">
            <div class="container-fluid2">
                <div class="tdd">
                    <h1 style="font-size: 45px;">The characteristic design of <br>the Cosmograph Daytona has <br>become iconic. </h1>
                </div>
            </div>
            <img src="img/cos3.jpg" alt="" style="height: 750px; width: 600px;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 40px;">
                </div>
            </div>
            <h2 class="d21" style="font-size: 45px;">A legendary design</h2>
            <p class="d2" style="font-size: 18px;">Bezel, minute track and three counters: this characteristic five-circle <br>iconography is emblematic of the Cosmograph Daytona. And its dial, <br>with a white background and black counters – sometimes known as <br>the “Panda” by collectors – has become a classic. Its legendary status <br>was earned, in part, on the wrist of Hollywood icon, experienced <br>racing driver and pioneering social entrepreneur Paul Newman.</p>
        </div>


        <div class="card-group">
            <div class="card">
                <img class="card-img-top" src="img/rcosc1.jpg" alt="Card image cap" id="1">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/rcosc2.jpg" alt="Card image cap" id="2">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/rcosc3.jpg" alt="Card image cap" id="3">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/rcosc4.jpg" alt="Card image cap" id="4">
            </div>
            <div class="card">
                <img class="card-img-top" src="img/rcosc5.jpg" alt="Card image cap" id="5">
            </div>
        </div>

        <div class="con3">
            <h2 class="d10" style="font-size: 45px;">"First you must know what you want, then you must do everything you can to get it. The will to succeed, a manifestation of the will to live, is of vital importance."</h2>
            <p class="d2">Hans Wilsdorf</p>
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 40px;">
                </div>
    ...
    <div class="video-container2 image-overlay">
        <video autoplay muted loop id="myVideo2" style="filter: blur(1.5px);">
            <source src="img/cossssss.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
        <div class="con4">
            <div class="overlay-text">
                <h2 class="e1" style="font-size: 45px;">Breaking away from convention</h2>
    ...
    <!-- <div class="container-fluid1">
        <div class="ii1">
            <img src="img/rcosm1.jpg" alt="" style="height: 700px; width: 750px;">
            <img src="img/rcosm2.jpg" alt="" style="height: 700px; width: 763.5px;">
        </div>
    </div> -->

    <div class="oo">
        <div class="container" style="margin-left: 6pc;">
            <img id="mg" src="img/file (2).png" alt="" style="height: 350px;" />
            ...
            <div class="con">
                <div class="box" id="b1">
                    ...
                    <p style="font-size: 17px;">Oyster, 40mm, Oystersteel <br>Reference 126500LN </p>
                    <p style="font-size: 17px;">$15,846.844</p>
                    <p style="font-size: 17px;">₹1,321,500</p>
                </div>
                <div class="box" id="b2">
                    <p>Oysterprepetual</p>
                    <p style="font-size: 17px;">This Dayton has a white Gold Features a white dial and High performance</p>
                    <p style="font-size: 17px;">Tachymetric scale</p>
                </div>
                <div class="box" id="b3">
                    <p style="font-size: 17px;">Gold is coveted for its <br> lustre and nobility. Map <br>Out their track times or <br>reliability. Together, they <br>harmoniously combine the <br>best of their properties.</p>
                    <p style="font-size: 17px;">White Dial</p>
                </div>
                <div class="box" id="b4">
                    <p style="font-size: 17px;">Oysterbracelet is a<br>perfectformfunction,<br>aesthetics and beauty even in the harshest polished environments.</p>
                    <p style="font-size: 17px;">Highly corrosion</p>
                </div>
            </div>
        </div>
        <div class="spacer">
    ...
    <div class="container-fluid3">
        <div class="spacer" style="background-color: black;">
            <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 0.5px;">
            </div>
        </div>
        <div class="container">
    ...
    <script>
        ...
        ScrollReveal().reveal('.box, .con1, .pi, .content1, .new, .container, .container-fluid, .pi, .d1, .d2, .e1, .e2, .tc1, .d12, .d11, .td', {
            delay: 500,
            origin: 'bottom'
        });
    </script>
