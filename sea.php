...
<div class="video-container">
        <video autoplay muted loop id="myVideo">
            <source src="img/seadweller.webm" type="video/mp4">
    ...
    <div class="bg2">
        <div class="con3">
            <h2 class="d1" style="font-size: 43px;">Gradually releasing interior pressure when the need arises.</h2>
            <div class="spacer">
        ...
        <div class="con43" >
            <h2 class="d1" style="margin-left: 28pc;">Inhabiting the sea</h2>
            <p class="d2" style="margin-left: 28pc;">In the 1960s, so-called “saturation” diving made it possible to remain at great depths for extended periods. It consists of housing divers in a pressurized habitat, so as to reproduce the pressure that prevails in their underwater working environment. This means that they need only undergo a single decompression process, at the very end of the mission. <br><br>This process can damage the watch. The divers breathe a mix of gases composed mainly of helium, whose extremely fine atoms can penetrate the case. On returning to the surface, the trapped helium can create a phenomenon of excess internal pressure liable to compromise the integrity of divers’ watches.</p>
            <img src="img/sea1.jpg" alt="" style="height: 750px; width: 600px; margin-left: 28pc;" class="i1">
            <div class="spacer">
                <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 90px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="video-container21">
        <video autoplay muted loop id="myVideo21">
            <source src="img/sead.webm" type="video/mp4">
            Your browser does not support HTML5 video.
        </video>
    </div>
    ...
    <div class="bg31">
        ...
        <img src="img/ss.jpg" alt="" style="height: 750px; width: 600px; margin-left: 28pc;" class="ic1">
        <div class="spacer">
            <div class="rrmc-content-spacer" data-desktop="50" data-tablet="50" data-mobile="50" data-unique-id="655612719" style="height: 40px;">
            </div>
        </div>
        <div class="con11">
            <h2 class="d1" style="margin-left: 28pc; font-size:46px">The new face of diving</h2>
            <p class="d2"style="margin-left: 28pc; font-size:18px">The number of undersea missions increased from the 1960s onwards, and they took on a new format. Divers were now not only faced with longer immersion times during saturation dives, but also with diving to greater depths. The professional watches designed for them therefore needed to be able to withstand ever-increasing pressure. <br><br>Guaranteed waterproof to a depth of 610 metres (2,000 feet) when it was launched in 1967, then to 1,220 metres (4,000 feet) from 1978, the Sea‑Dweller combines all the attributes of the modern divers’ watch. <br><br> Tested in real-life conditions as part of the Tektite programme habitats.</p>
            <div class="spacer">
    ...
    <div class="oo">
        <div class="container" style="margin-left: 6pc;">
            <img id="mg" src="img/file7.png" alt="" />
            ...
            <div class="con">
                <div class="box" id="b1">
                    <p>Sea-Dweller</p>
                    <p style="font-size: 17px;">Oyster, 43mm, Oystersteel <br>Reference 126600</p>
                    <p style="font-size: 17px;">$13,904.211</p>
                    <p style="font-size: 17px;">₹1,159,500</p>
                </div>
                <div class="box" id="b2">
                    <p>Oysterprepetual</p>
                    <p style="font-size: 17px;">This Sea-Dweller has a white Gold Features a white dial and an oyster bracelate</p>
                    <p style="font-size: 17px;">Citizen Of The Deep</p>
                </div>
                <div class="box" id="b3">
                    <p style="font-size: 17px;">It Is equipped with <br>lustre and nobility. Steel <br>reinforces strength and <br>reliability. Together, they <br>harmoniously combine the <br>best of their properties.</p>
                    <p style="font-size: 17px;">Luminescent Display</p>
                </div>
                <div class="box" id="b4">
                    <p style="font-size: 17px;">Sea-Dweller is a<br>perfectformfunction,<br>aestheticsand technology,<br> designed to be both Rolex Models.</p>
                    <p style="font-size: 17px;">Intense black dial</p>
                </div>
            </div>
        </div>
        <div class="spacer">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".container").hover(function() {
                ...
                $("#a").css("margin", "-29pc -20pc").css("position", "absolute").css("transition", "1s").css("opacity", "1");
                $("#bc").css("margin", "-29pc -10pc").css("position", "absolute").css("transition", "2s");
                $("#c").css("margin", "-29pc 2pc").css("position", "absolute").css("transition", "3s");
                $("#d").css("margin", "-29pc 12pc").css("position", "absolute").css("transition", "4s");
                $("#e").css("margin", "-29pc 22pc").css("position", "absolute").css("transition", "5s");
